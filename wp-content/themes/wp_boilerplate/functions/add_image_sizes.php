<?php
	...
	function dl_image_sizes($sizes) {
		$addsizes = array(
			...
			"custom_blog" => __( "Tamaño personalizado del blog")
		);
	...
	if ( function_exists( 'add_theme_support' ) ) { 
		...
		add_image_size( 'custom_logo', 600, 370, true);		// Personalización del tamaño del logo

		add_image_size( 'custom_blog', 640, 480, true);
