<?php 
	...
	function dl_enqueue_scripts() {
		...
		wp_register_script('maps', get_parent_theme_file_uri('assets/js/maps.js'), array('jQuery3'), null, true);
	...
	add_action( 'wp_enqueue_scripts', 'dl_enqueue_scripts','my_scripts_enqueue' );
?>